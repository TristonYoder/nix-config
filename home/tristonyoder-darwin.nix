...

{
  ...
  programs.zsh = {
    shellAliases = {
      ...
      hms = "sudo darwin-rebuild switch --refresh --flake github:TristonYoder/nix-config && exec zsh";
      hmswitch = "sudo darwin-rebuild switch --refresh --flake github:TristonYoder/nix-config && exec zsh";
    };
  };
