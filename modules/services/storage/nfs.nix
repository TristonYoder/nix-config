  ...
  options.modules.services.storage.nfs = {
    ...
    exports = mkOption {
      ...
      default = ''
        ...
        /data/tristonyoder      10.150.10.0/23(rw,fsid=1003,no_subtree_check,crossmnt) 10.150.100.0/23(ro,fsid=1003,no_subtree_check,crossmnt) 10.150.100.10(rw,fsid=1003,no_subtree_check,crossmnt,no_root_squash) 10.100.0.0/18(rw,fsid=1003,no_subtree_check,crossmnt) 100.64.0.0/10(rw,fsid=1003,no_subtree_check,crossmnt)
